...
public class PlacedFeatures {
    ...
    public static final ResourceKey<PlacedFeature> STONE_OF_HOPE_PLACED_KEY = registerKey("stone_of_hope_placed");
    ...
    public static void bootstrap(BootstapContext<PlacedFeature> context) {
        ...
        register(context, STONE_OF_HOPE_PLACED_KEY, configuredFeatures.getOrThrow(ConfiguredFeatures.OVERWORLD_STONE_OF_HOPE_KEY),
